...
Being able to file the bank statement in the right folder with the [only right method of naming files] seemed like an easy win when starting the paperless journey.
